  ...
  return (
    <div className="row">
      <div className="col s12 m6 l6" style={{ paddingLeft: '3rem' }}>
        <h4>
          <strong>MBF WELCOMES YOUR SUPPORT IN ALL THESE ENDEAVORS</strong>
        </h4>
        <p>
          MBF is a non-profit, non-description, and Individuals Supported Faith based Organization whose Mission is to
          provide Fonchbegkin - Fondness for all people (genuine compassion of heart for all human kind, regardless of
          colour, creed, national origin, economic condition, etc).
        </p>
        <p>You too can be part of this positive change</p>

        <p>
          <strong>Want to support us by making a direct transfer to our bank account?</strong>
        </p>

        <h6>
          <strong>Domestic Payments (₦)</strong>
        </h6>
      ...
      <div className="col s12 m6 l6">
        <h4 style={{ padding: '6rem 0 1rem 0' }}>
          <strong>Domestic Donatation (₦)</strong>
        </h4>
        <div className="row">
